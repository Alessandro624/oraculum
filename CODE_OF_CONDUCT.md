...
This project exists to poke fun at computational complexity theory.
We take that lightly. We take how we treat each other seriously.

The following is adapted from the Contributor Covenant, version 2.1.
...
or the email listed in SECURITY.md.
...
of Conduct, for a specified period of time.
